...
import { TovarBox, TovarInfo, TovarItem, TovarItemListPropItem, TovarItemListProps, TovarList } from './tovarsByType.style';
                ...
                {tovars.map(tovar =>
                    <li key={tovar.id}>
                        <TovarItem>
                            ...
                            <TovarInfo>
                                <TovarItemListProps>
                                    <TovarItemListPropItem><AiOutlineDollarCircle /> {tovar.cost}</TovarItemListPropItem>
                                    <TovarItemListPropItem><AiOutlineRise />{tovar.popularity}</TovarItemListPropItem>
                                    <TovarItemListPropItem><AiOutlineGold />{tovar.quantity}</TovarItemListPropItem>
                                </TovarItemListProps>
                                <TovarItemListProps>
                                    <TovarItemListPropItem><AiOutlineForm /></TovarItemListPropItem>
                                    <TovarItemListPropItem><AiOutlineDelete /></TovarItemListPropItem>
                                </TovarItemListProps>
